...
# Directory to save downloaded images (updated to 'media/products/images')
image_dir = os.path.join('media', 'products', 'images')
            ...
            if image_url:
                ...
                if image_path:
                    ...
                    with open(image_path, 'rb') as file:
                        product_image = ProductImage.objects.create(product=product, image=File(file, name=filename))
